...
Interfaz.prototype.mostrarMensaje=function(mensaje,tipoError){
...
////imprime el resultado de la cotizacion  prototype
...
formulario.addEventListener('submit',function(e){
   ...
   //leer el valor de un radio buton
    ...
    if(marcaSeleccionada===''||anioSeleccionado===''||tipo===''){
        interfaz.mostrarError('Faltan complettar algunos cacmpos','error');
    }else{
